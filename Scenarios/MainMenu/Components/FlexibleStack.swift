...
//  https://github.com/minacod/SwiftUILayoutTutorial/blob/main/SwiftUILayout/FlexibleStack.swift
//  This code is publicly available and used for flexible display of Promissory Note content in LoanAgreementView
//
